        ...
        >
            ...
            >
                ...
                <div className="p-6">
                    ...
                    {venue.about?.desc?.[0] && (
                        <p className="text-[#5a4d3e] dark:text-[#c5b49e] text-sm leading-relaxed mb-6 line-clamp-3">{venue.about.desc[0]}</p>
                    )}
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-20">
                            <div className="w-20 h-20 bg-[#f5ede5] dark:bg-[#241a06] rounded-full flex items-center justify-center mx-auto mb-6">
                                <Trophy size={32} className="text-[#8a7968] dark:text-[#c5b49e]" />
                            </div>
