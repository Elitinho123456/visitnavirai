...
// Função para retornar ícone e cor baseado no clima
...
export default function WeatherWidget() {
    ...
    if (loading) return (
        <div className="flex items-center justify-center p-8 bg-white/50 dark:bg-black/10 backdrop-blur-md rounded-2xl animate-pulse">
            <div className="text-(--color-neutral-gray)">{t('weather.loading')}</div>
        </div>
    );
            ...
            <div className="relative z-10 w-full">
                ...
                <div className="grid grid-cols-3 gap-2 w-full pt-4 border-t border-(--color-neutral-gray)/20">
                    <div className="flex flex-col items-center gap-1 group/item">
                        ...
                        <span className="text-xs text-(--color-neutral-gray) font-medium uppercase">{t('weather.min')}</span>
                    ...
                    <div className="flex flex-col items-center gap-1 border-l border-r border-(--color-neutral-gray)/20 group/item">
                        ...
                        <span className="text-xs text-(--color-neutral-gray) font-medium uppercase">{t('weather.humidity')}</span>
                    ...
                    <div className="flex flex-col items-center gap-1 group/item">
                        ...
                        <span className="text-xs text-(--color-neutral-gray) font-medium uppercase">{t('weather.max')}</span>
