            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {filteredHotels.map((hotel) => (
                        <div key={hotel._id} className="bg-white dark:bg-[#241a06] rounded-3xl overflow-hidden border border-[#ede0d8] dark:border-[#3a2e1a] shadow-sm hover:shadow-xl transition-all group flex flex-col sm:flex-row">
                            ...
                            <div className="p-6 flex-1 flex flex-col justify-between">
                                <div>
                                    <h3 className="text-xl font-bold text-[#241a06] dark:text-[#f0e6d6] line-clamp-1">{hotel.name}</h3>
                ...
                <div className="bg-white dark:bg-[#241a06] rounded-3xl p-12 text-center border border-[#ede0d8] dark:border-[#3a2e1a] shadow-sm">
                    ...
                    <h3 className="text-xl font-bold text-[#241a06] dark:text-[#f0e6d6]">Nenhum registro encontrado</h3>
                    <p className="text-[#8a7968] dark:text-[#c5b49e] mt-2">Tente ajustar sua busca ou cadastre um novo estabelecimento.</p>
                </div>
            )}
