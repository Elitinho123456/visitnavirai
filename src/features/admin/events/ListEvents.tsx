        ...
        <div className="space-y-6 pb-20">
            ...
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row justify-between items-end md:items-center gap-4">
                    <div>
                        <h2 className="text-2xl font-black text-[#241a06] dark:text-[#f0e6d6]">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredEvents.map((event) => (
                            <div key={event._id} className="bg-white dark:bg-[#241a06] rounded-3xl overflow-hidden border border-[#ede0d8] dark:border-[#3a2e1a] shadow-sm flex flex-col group">
                                <div className="w-full h-48 relative overflow-hidden bg-[#ede0d8] dark:bg-[#2e2310]">
                                    {event.image ? (
                                        ...
                                        <div className="w-full h-full flex flex-col items-center justify-center text-[#8a7968] dark:text-[#8a7968]">
                                            <ImageIcon size={48} />
                                ...
                                <div className="p-5 flex-1 flex flex-col justify-between">
                                    <div>
                                        <h3 className="font-bold text-[#241a06] dark:text-[#f0e6d6] text-lg line-clamp-1">{event.name}</h3>
                                        <div className="flex flex-col gap-2 text-[#8a7968] dark:text-[#c5b49e] text-xs mt-3">
                    ...
                    <div className="text-center py-20 bg-[#faf5f0] dark:bg-[#241a06]/70 rounded-3xl border border-dashed border-[#ede0d8] dark:border-[#3a2e1a]">
                        <p className="text-[#8a7968] dark:text-[#c5b49e]">Nenhum evento encontrado.</p>
                    </div>
                )}
            </div>
            ...
            <div className={`fixed inset-y-0 right-0 w-full md:w-112.5 h-full bg-white dark:bg-[#241a06] shadow-2xl border-l border-[#ede0d8] dark:border-[#3a2e1a] transform transition-transform duration-300 z-50 flex flex-col ${isDrawerOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="flex items-center justify-between p-6 border-b border-[#ede0d8] dark:border-[#3a2e1a] bg-[#faf5f0] dark:bg-[#1a1208]/60 shrink-0">
                    <div>
                        <h3 className="text-xl font-bold text-[#241a06] dark:text-[#f0e6d6]">Editar Evento</h3>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-5 customized-scrollbar">
                    <form id="edit-form" onSubmit={handleEditSubmit} className="space-y-5">
                        ...
                        <div>
                            <label className="flex items-center gap-2 text-sm font-bold text-[#241a06] dark:text-[#f0e6d6] mb-2"><CalendarIcon size={16} /> Data</label>
                            <input type="date" required className="w-full px-4 py-3 border border-[#ede0d8] dark:border-[#3a2e1a] rounded-xl bg-[#faf5f0] dark:bg-[#1a1208] text-[#241a06] dark:text-[#f0e6d6] focus:ring-2 focus:ring-(--color-primary) outline-none"
                    ...
                    <div className="bg-white dark:bg-[#241a06] rounded-4xl p-8 max-w-md w-full relative z-10 shadow-2xl border border-[#ede0d8] dark:border-[#3a2e1a]">
                        ...
                        <div className="mt-8 space-y-3">
                            ...
                            <button
                                ...
                                className="w-full bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-800 py-4 rounded-2xl font-bold text-lg hover:bg-amber-100 dark:hover:bg-amber-900/40 transition-all flex items-center justify-center gap-2 cursor-pointer"
                            >
