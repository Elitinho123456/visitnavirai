...
export default function Dashboard() {
    ...
    const { user, loading: loadingUser, logout, setUser } = useAuth();
    ...
    const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            const uploadRes = await apiFetch(`${API_BASE_URL}/api/imgs/upload`, {
                method: "POST",
                body: fd
            });
            ...
            const updateRes = await apiFetch(`${API_BASE_URL}/api/users/${user.id}/profile-image`, {
                method: "PUT",
                headers: {
            ...
            toast.info("Não foi possível atualizar sua foto de perfil.");
        } finally {
