...
import { Plus, Trash2, ArrowLeft, Upload, Star, ImagePlus, X } from "lucide-react";
            ...
            <div className="bg-white dark:bg-[#241a06] rounded-3xl p-6 md:p-10 shadow-sm border border-[#ede0d8] dark:border-[#3a2e1a]">
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                        ...
                        <p className="text-[#8a7968] dark:text-[#c5b49e]">Cadastre os detalhes do complexo esportivo, quadra ou campo.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-12">
                    ...
                    <section>
                        ...
                        <div className="space-y-2 mt-6">
                            <label className="block text-sm font-bold text-[#241a06] dark:text-[#f0e6d6] ml-1">Galeria de Fotos (Arraste múltiplas fotos)</label>
                            
                            {galleryFiles.length > 0 && (
                                <div className="flex flex-wrap gap-3 p-4 bg-[#faf5f0] dark:bg-[#1a1208]/60 border border-[#ede0d8] dark:border-[#3a2e1a] rounded-2xl mb-2">
