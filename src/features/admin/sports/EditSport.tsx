            ...
            <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-slate-100">
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500">Atualize os detalhes do local de esporte e lazer.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-12">
                    ...
                    <section>
                                ...
                                {formData.highlight && (
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <select 
                                            ...
                                            className="px-3 py-1 bg-slate-50 border border-slate-200 rounded-lg text-sm font-bold text-slate-700 outline-none w-44 cursor-pointer"
                                        >
                        ...
                        {formData.highlightExpiration && formData.highlight && (
                            <div className="mb-6 p-4 bg-yellow-50 border border-yellow-100 rounded-2xl flex items-center gap-3 text-yellow-800 text-sm">
                    ...
                    <section>
                        ...
                        <div className="space-y-2 mt-6">
                            <label className="block text-sm font-bold text-slate-700 ml-1">Galeria de Fotos</label>
                            
                            {/* Imagens Existentes da Galeria */}
                            {formData.gallery && formData.gallery.length > 0 && (
                                <div className="space-y-1 mb-3">
                                    <div className="text-xs font-bold text-slate-400">Imagens Atuais (Clique para remover):</div>
                            ...
                            {newGalleryFiles.length > 0 && (
                                <div className="space-y-1 mb-3">
                                    <div className="text-xs font-bold text-emerald-600">Novas fotos a serem enviadas:</div>
                                    <div className="flex flex-wrap gap-3 p-4 bg-emerald-50/50 border border-emerald-100 rounded-2xl">
