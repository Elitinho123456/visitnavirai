            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {filteredRestaurants.map((restaurant) => (
                        <div key={restaurant._id} className="bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all group flex flex-col sm:flex-row">
                            ...
                            <div className="p-6 flex-1 flex flex-col justify-between">
                                <div>
                                    <h3 className="text-xl font-bold text-slate-800 line-clamp-1">{restaurant.name}</h3>
                ...
                <div className="bg-white rounded-3xl p-12 text-center border border-slate-100 shadow-sm">
                    ...
                    <h3 className="text-xl font-bold text-slate-800">Nenhum restaurante encontrado</h3>
                    <p className="text-slate-500 mt-2">Tente ajustar sua busca ou cadastre um novo restaurante.</p>
                </div>
            )}
