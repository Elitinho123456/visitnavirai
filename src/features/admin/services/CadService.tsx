...
export default function CadService() {
            ...
            <div className="bg-white dark:bg-[#241a06] rounded-3xl p-6 md:p-10 shadow-sm border border-[#ede0d8] dark:border-[#3a2e1a]">
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                        ...
                        <p className="text-[#8a7968] dark:text-[#c5b49e]">Cadastre os detalhes do serviço local para exibição no portal.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-12">
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="block text-sm font-bold text-[#241a06] dark:text-[#f0e6d6] ml-1">Nome do Serviço / Estabelecimento</label>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {/* Foto da Estrutura / Frota - Drag & Drop */}
                            <div className="space-y-2">
